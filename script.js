...
const danceTilesWin = 500;
const tiles = document.querySelectorAll(".guess-grid .tile");
...
function deleteKey() {
  ...
  if (lastTile == null) returnlastTile;
